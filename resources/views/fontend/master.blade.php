                ...
                <div class="header-navbar">
                    <nav class="navbar">
                        ...
                        <div class="collapse navbar-collapse" id="main_nav">
                            <ul class="navbar-nav ">
                                <li class="nav-item ">
                                    <a class="nav-link active" href="{{ route('fontend')}}"> Home </a>
                                </li>
                                <li class="nav-item">
                    ...
                    <div class="botton-sub">
                        @auth('guestlogin')
                            <div class="dropdown">
                                ...
                                <a class="dropdown-item" href="{{ route('guest.logout')}}">Log out</a>
                                </div>
                            </div>
                        @else
                            <a href="{{ route('guest.reg.me')}}" class="btn-subscribe">sign up</a>
                        @endauth
                    </div>
                    <!--navbar-toggler-->
