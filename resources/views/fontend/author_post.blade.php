        ...
        <div class="row">
            ...
            <div class="col-lg-8 oredoo-content">
                <div class="theiaStickySidebar">
                    <!--post1-->
                    @foreach ($author_post as $auth_post)                      
                    <div class="post-list post-list-style4 pt-0"> 
                        ...
                        <div class="post-list-content">
                            ...
                            <h5 class="entry-title">
                                <a href="post-single.html">{{ $auth_post->title }}</a>
                            </h5>  
                            <div class="post-btn">
                    ...
                    <div class="sidebar">
                        ...
                        <div class="widget ">
                            ...
                            <div class="widget-categories">
                                @foreach ($author_post as $category)                                  
                                    <a class="category-item" href="#">
                                        <div class="image">
                                            <img src="{{ asset('uploads/category')}}/{{ $category->rel_to_category->category_image}}" alt="">
                                        </div>
                                        
                                        <p>{{ $category->rel_to_category->category_name}}   </p>
                                    </a>
                                @endforeach
                            </div>
                        </div>
