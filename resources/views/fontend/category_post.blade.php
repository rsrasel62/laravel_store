...
<section class="blog-layout-2">
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="post-list-content">
                        ...
                        <ul class="entry-meta">
                            <li class="post-author-img">
                                ...
                                @else
                                <img src="{{ asset('uploads/user')}}/{{ $category_post->rel_to_user->image}}" alt=""></td>

                                @endif
                            <li class="post-author"> <a href="{{ route('author.post', $category_post->author_id)}}" >{{ $category_post->rel_to_user->name }}</a></li>
                            <li class="entry-cat"> <a href="" class="category-style-1 "> <span class="line"></span>{{ $category_info->category_name}}</a></li>
                            <li class="post-date"> <span class="line"></span>{{ $category_post->created_at->format('M/d/Y')}}</li>
                        </ul>
                        <div class="post-exerpt">
                            <p>{!! $category_post->short_desp !!}</p>
                        </div>
                        <div class="post-btn">
            ...
            {{ $category_posts->links('vendor.pagination.custompaginate')}}
        </div>
    </div>
</section>
