        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="emails">
              <ul class="nav sub-menu">
                ...
                <li class="nav-item">
                  <a href="{{ route('users')}}" class="nav-link">Userlist</a>
                </li>
				<li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="tag">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="{{ route('tag')}}" class="nav-link">Add new Tags</a>
                </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="role">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="{{ route('role')}}" class="nav-link">Add new role</a>
                </li>
...
{{-- 
		  ...
		  <li class="nav-item">
            ...
            <div class="collapse" id="post">
              <ul class="nav sub-menu">
                ...
                <li class="nav-item">
                  <a href="{{ route('post')}}" class="nav-link">My post</a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('about.us')}}" class="nav-link">About Post</a>
                </li>
                <li class="nav-item">
		  ...
		  <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#Fontend" role="button" aria-expanded="false" aria-controls="emails">
              <i class="link-icon" data-feather="mail"></i>
              <span class="link-title">Fontend all</span>
              <i class="link-arrow" data-feather="chevron-down"></i>
            </a>
            <div class="collapse" id="Fontend">
              <ul class="nav sub-menu">
				@can('show_post')
				<li class="nav-item">
				  <a class="nav-link" data-toggle="collapse" href="#post" role="button" aria-expanded="false" aria-controls="emails">
